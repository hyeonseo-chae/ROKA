module.exports.function = function dday_finish (startDate,find, kinds, endDate) {
...
console.log("now",now)
console.log("end",end)
const remining_day = rtn_day(now,convert(end));
const tot_day = rtn_day(convert(start),convert(end));
